...
export default function AdminProfile() {
	...
	return (
		<div
			style={{
				backgroundImage: `url(${data.profile_banner_url})`,
				backgroundSize: "cover"
			}}
			className="z-20 flex-row space-x-2 flex self-center p-2 h-full w-max lg:absolute lg:left-0"
		>
			<img
			...
			<div className="z-20 absolute -right-8 group self-center">
				<GoSignOut
					size={24}
					className="text-slate-400 group-hover:scale-105 ml-4"
					strokeWidth={2}
				/>
			</div>
		</div>
