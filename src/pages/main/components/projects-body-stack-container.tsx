...
export default function ProjectsBodyStackContainer(props: { stack: any }) {
	...
	return (
		...
		>
			...
			/>
			<span className="absolute lg:px-2 lg:py-2 bg-white border-1 self-center  top-10 z-20 max-h-120 w-max max-w-60 hidden group-active:inline-block lg:group-hover:inline-block">
				<h6>
					{stack.key}
