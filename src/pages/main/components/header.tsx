...
export default function Header() {
	...
	return (
		<div className="w-[90%] self-center lg:w-[80%] bg-white lg:mt-10 py-5 px-10 flex-col lg:flex-row flex rounded-t-[40px] relative lg:justify-between">
			<img
				style={{ flex: 0.2 }}
				src={avatar}
				className="justify-center rounded-full self-center aspect-square max-w-[80%] lg:max-h-48 lg:max-w-48"
			/>
			<div style={{ flex: 0.6 }} className="flex-col  flex space-y-4">
				<h1 className="font-bold flex flex-col lg:flex-row text-center lg:text-left text-4xl text-slate-800 lg:text-6xl">
					phasenull.dev
