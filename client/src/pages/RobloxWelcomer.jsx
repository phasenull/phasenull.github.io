		...
		<div className="h-screen pt-24">
			<div className="mx-auto max-w-7xl px-6 lg:px-8 select-none">
				...
				<p className="text-center text-base text-white drop-shadow-2xl text-4xl font-bold pb-5">
					Here, in
					<a href={"https://roblox.com/groups/" + group_data.group_id} target="_blank" rel="noreferrer" className="font-extrabold inline text-green-500 transition-color duration-300 hover:text-blue-400 inline">
						{" " + (group_data.name)}
					</a> we have
				</p>
